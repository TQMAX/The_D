...
class DZMReadConfigure: NSObject {
    ...
    /// 背景颜色索引
    @objc var fontColorIndex:UIColor!
    ...
    var textColor:UIColor! {
        ...
        // 固定颜色
//        return HexColor(hexValue: 0x333333)
...
//        return DZM_READ_TEXT_COLORS[textColorIndex.intValue]
        ...
        // 日夜间切换
         if DZMUserDefaults.bool(DZM_READ_KEY_MODE_DAY_NIGHT) {
            return HexColor(hexValue: 0xFF0000)
         }else{ return HexColor(hexValue: 0x333333) }
    }
...
//                    "fontColor": fontColorIndex,
    ...
    private func initData() {
        ...
        // 字体颜色
        if (fontColorIndex == nil) {

            fontColorIndex = textColor
//            if DZMUserDefaults.bool(DZM_READ_KEY_MODE_DAY_NIGHT) {
//                fontColorIndex = NSNumber(value: HexColor(hexValue: 0xeeeeeee))
//            }else{ return HexColor(hexValue: 0x333333) }
        }
